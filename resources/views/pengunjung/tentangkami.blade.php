                ...
                <section class="abaut">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-5 text-center">
                            <p>Mojo adalah kelurahan yg paling rapih dan terkoordinir dari kelurahan di kecamatan gubeng
                                ini mengenai pengolahan
                                sampahnya. tapi tak heran jika masa ke masa perlu adanya sentuhan teknologi agar
                                pendataan sampah tiap warga
                                berjala dengan lancar. salah satunya adalah dibuatkannya aplikasi administrasi </p>
                        </div>
                        <div class="col-md-5 text-center">
                            <p>hingga pembukuan
                                bank sampah di kelurahan mojo. tak hanya itu, kami dari tim HIMATIFTA juga menciptakan
                                sensor iOt pendeteksi
