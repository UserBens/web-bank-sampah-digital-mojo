...
<head>
    ...
    <title>Bank Sampah Digital Mojo | Tentang Kami</title>
		...
		<div class="container">
			...
			<div class="row justify-content-center">
				<div class="col-lg-4">
					<div class=" bg-white mb-3" >
						...
						<div class="card-body">
                           ...
                           <div class="mt-4 card-text d-flex align-items-center">
                            <span class="fa-solid fa-envelope mr-5"></span>
                            Jl. Kalidami Jl. Jojoran IIIA. Mojo, Kec. Gubeng, Surabaya, Jawa Timur 60285.
                            </div>
                            <div class="mt-3 card-text d-flex align-items-center">
                            <span class="mr-4 fa-solid fa-location-dot"></span>
                            mojobanksampah@gmail.com
                            </div>
					...
					<div class="">
                        ...
                        <span class="glyphicon glyphicon-envelope"></span>
					  	<ul class="list-group list-group-flush">
						    <li class="list-group-item text-success "><h4>+62 853-7748-786</h4></li>
                         ...
                         <ul class="mt-5 list-inline">
                            <i class="list-inline-item fab fa-facebook-f fa-2x" style="color: #3b5998;"></i>
                            <i class="list-inline-item fab fa-instagram fa-2x" style="color: #ac2bac;"></i>
                            <i class="list-inline-item fab fa-twitter fa-2x" style="color: #55acee;"></i>
                            <i class="list-inline-item fab fa-youtube fa-2x" style="color: #ed302f;"></i>
                         </ul>
				...
				<div class="col-lg-6">
                    ...
                    <p class="mt-4 card-text">Silakan hubungi kami melalui alamat berikut atau dengan mengisi formulir kontak yang tersedia</p>
                    <div class="form-group ">
					    <label for="exampleInputEmail1">Nama Anda</label>
					    <input type="name" class="form-control bg-tertiary" id="exampleInputEmail1" aria-describedby="nameHelp">
                      ...
                      <div class="mb-3">
                        <label for="exampleFormControlTextarea1" class="form-label">Subjek Pesan</label>
